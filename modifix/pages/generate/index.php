...
<html>
    <head>
        <title>Generate Tracks | AdminSuper</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Create Tracks</li>
                    </ol>
                </section>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <form name="form" method="POST">
                                ...
                                <input type="submit" class="btn btn-block btn-primary" name="sub" value="GENERATE TRACKS">
                            </form>
                        </div><!-- /.box-body -->
