    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            if (isset($_POST['guardar'])) {
                                ...
                                $dat = $promo->get_promocion($_POST['code']);
                                if (count($dat) == 0) {
                                    $promo->insert_promocion($_POST['code'], $_POST['porciento']);
                                    echo "Has creado una promocion!<br>";
                                    echo "<a href='" . BASE_URL_ADMIN . "/pages/promociones/'>Ver promociones!</a>";
                                } else {
                                    echo "Ya existe este codigo, porfavor inserte otro!";
                                }
                            }
                            ?>
                            <form method="POST">
                                <div class="form-group">
                                    <label>Codigo: <button class="btn btn-info" type="button" id="btn-generate-code">Generar Code Random</button></label>
                                    <input type="text" id="descuento" placeholder="Escribe el codigo de descuento" name="code" class="form-control" value="<?php if (isset($_POST['codigo'])) echo $_POST['codigo']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Porciento:</label>
                                    <input type="text" name="porciento" id="porcentaje" value="<?php
                                    if (isset($_POST['codigo'])) {
                                        echo $_POST['porcinto'];
                                    } else {
                                        echo "20";
                                    }
                                    ?>"  placeholder="Escribe el porcentaje" required class="form-control">
                                </div>
                                <div class="form-group">
                                    <input name="guardar" value="1" type="hidden">
                                    <input type="submit" class="btn btn-block btn-success" value="Crear codigo promocional">
                                </div>
                            </form>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
        ...
        <script>
            ...
            $("#btn-generate-code").on("click", function (e) {
                ...
                var input = $("#descuento");
                $.ajax({
                    url: "https://www.superbackings.com/admin/generateCodePromocional/",
                    type: "GET",
                    success: function (data, textStatus, jqXHR) {
                        input.val(data);
                    }
